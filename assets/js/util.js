(function($) {
	...
	$.fn.panel = function(userConfig) {
		...
		// Config.
			config = $.extend({
				...
				// Esconder painel com tecla "Esc".
					hideOnEscape: false,

				// Esconder painel com deslize.
					hideOnSwipe: false,

				// Resetar posicao do scroll ao esconder.
					resetScroll: false,

				// Resetar formulario ao esconder.
					resetForms: false,

				// Lado do painei da janela de exibicao aparecera.
					side: null,
	...
	$.fn.placeholder = function() {
		...
		// O navegador suporta nativamente espaços reservados?
			...
			$elements.each(function() {
				...
				// Não moveu? Mova.
					if (!$e.data(key)) {
						...
						// Mova o elemento para o topo do parent.
							$e.prependTo($parent);
